...
public class DList extends List {
  ...
  public void insertFront(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
	DListNode inserting = newNode(item, this, head, head.next);
    head.next.prev = inserting;
    head.next = inserting;
    size++;
  }
  ...
  public void insertBack(Object item) {
    // Your solution here.  Similar to Homework 4, but now you need to specify
    //   the `list' field (second parameter) as well.
	DListNode inserting = newNode(item, this, head.prev, head);
    head.prev.next = inserting;
    head.prev = inserting;
    size++;
  }
  ...
  public String toString() {
    ...
    //System.out.println(current + "wut");
    while (current != head) {
